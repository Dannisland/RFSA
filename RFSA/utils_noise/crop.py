...
def get_random_rectangle_inside(image, height_ratio_range, width_ratio_range):
    ...
    # print(remaining_height,remaining_width)
    ...
    # print(height_start, height_start+remaining_height, width_start, width_start+remaining_width)
...
def main():
    ...
    a = Crop((0.9,0.9),(0.9,0.9))
    blured_img = a(img)
    vutils.save_image(blured_img,'c.png')
    print(blured_img)
